...
<section id="indiana-section">
  <h2>Indiana Section</h2>
  <p>The Indiana Privacy String consists of the following components. Users should employ the Indiana Privacy String only if they have determined the Indiana Consumer Data Protection Act, Ind. Code Ann. § 24-15, applies to their processing of a consumer’s personal data.</p>
  ...
  <table>
    ...
    <tr>
      ...
      <td>25</td>
      <td><p>The Indiana Section is registered as Section ID 25 under the GPP.</p></td>
    </tr>
    <tr>
      <td>Client side API prefix</td>
      <td>usin</td>
      <td><p>The Indiana Privacy Section is registered with client side API prefix “usin” in the GPP Client Side API.</p></td>
    </tr>
  </table>
  ...
  <p>The core subsection must always be present. Where terms are capitalized in the ‘description’ field they are defined in Indiana Consumer Data Protection Act. It consists of the following fields:</p>
  <table>
    <tr>
  ...
  <p>Optional subsection used to indicate when consent was received from the consumer to process his or her sensitive data in accordance with Ind. Code Ann. § 24-15-4-1(5).</p>
  <table>
    <tr>
      <td><strong>Field</strong></td>
