...
<h2>Oregon Section</h2>
<p>The Oregon Privacy String consists of the following components. Users should employ the Oregon Privacy String only if they have determined the Oregon Act Relating to Protections for Personal Data of Consumers, SB 619 (2023), applies to their processing of a consumer’s personal data.</p>
<h3>Summary</h3>
<div>
  <table>
    <tbody>
      ...
      <tr>
        ...
        <td>15</td>
        <td>The Oregon Section is registered as Section ID 15 under the GPP.</td>
      </tr>
      <tr>
        <td>Client side API prefix</td>
        <td>usor</td>
        <td>The Oregon Privacy Section is registered with client side API prefix “usor” in the GPP Client Side API.</td>
      </tr>
    </tbody>
  </table>
</div>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Two bits for each Data Activity:<p></p><code>0</code> = Not Applicable, the Controller does not
          <span style="color:rgb(36, 41, 47);">Process Sensitive Data of a known Child</span><p></p><code>1</code> = Consent<p></p><code>2</code> = No Consent&nbsp;<span style="color:rgb(36, 41, 47);"><p></p>(1). Consent to Process Sensitive Data from a Known Child.</span><p></p>
