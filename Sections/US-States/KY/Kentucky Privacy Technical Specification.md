...
<section id="kentucky-section">
  <h2>Kentucky Section</h2>
  <p>The Kentucky Privacy String consists of the following components. Users should employ the Kentucky Privacy String only if they have determined the Kentucky Act relating to consumer data privacy, HB 15 (2024), applies to their processing of a consumer’s personal data.</p>
  ...
  <table>
    ...
    <tr>
      ...
      <td>26</td>
      <td><p>The Kentucky Section is registered as Section ID 26 under the GPP.</p></td>
    </tr>
    <tr>
      <td>Client side API prefix</td>
      <td>usky</td>
      <td><p>The Kentucky Privacy Section is registered with client side API prefix “usky” in the GPP Client Side API.</p></td>
    </tr>
  </table>
  ...
  <p>Optional subsection used to indicate when consent was received from the consumer to process his or her sensitive data in accordance with Kentucky Act, Sec. 4(1)(e).</p>
  <table>
    <tr>
      <td><strong>Field</strong></td>
  ...
  <table>
    ...
    <tr>
      <td>3</td>
      <td><p>Mental or Physical Health Diagnosis</p></td>
    </tr>
    <tr>
      <td>4</td>
